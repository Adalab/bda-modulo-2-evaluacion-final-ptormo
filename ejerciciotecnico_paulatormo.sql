...
HAVING AVG(length) > 120;
 ...
 ON a.actor_id = fa.actor_id
 GROUP BY a.actor_id, a.first_name, a.last_name -- agrupamos por nombre y actor_id que es único para cada actor
 HAVING COUNT(fa.film_id) >= 5; -- al menos cinco, inclusive 5, contamos por id que es unico = 1 pelicula
...
SELECT a.first_name, a.last_name -- quiero que me devuelva el nombre de los que NOT IN mi subconsulta
FROM actor AS a
WHERE a.actor_id NOT IN (SELECT a.first_name, a.last_name -- nos devuelve actores que salen en horror
 FROM actor AS a
